...
\begin{frame}
  ...
  \begin{block}{Take a look:}
    \begin{itemize}
      ...
      \item and many many other resources on the Internet freely available. If you can read it, knowledge is reachable!\footnote{\href{https://silverskylabs.github.io/yakhak/}{such as this example of Wireshark using}}
    \end{itemize}
  \end{block}
\end{frame}
