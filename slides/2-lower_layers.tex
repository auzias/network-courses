...
\subsection{Data Link}
  ...
  \begin{frame}
	...
	\centering
	  \begin{tabular}{|c|c|}
	    \multicolumn{2}{c}{32 bits (4 * 4 bytes)} \\ \hline
	    \color{red}Networks bit & \color{blue}Host bit \\ \hline
	  \end{tabular}
	\caption{IP address}
    ...
    \pause
    \begin{block}{Mask}
      Network and host bit are separated accroding to the \textbf{mask}.%http://www.cs.fsu.edu/courses/netdesign/ip_addr_tutor.pdf
    \end{block}      
