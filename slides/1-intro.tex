...
\subsection{Network classification}
  ...
  \begin{frame}
    ...
    \begin{figure}[p]
      \centering
      \includegraphics[height=3cm]{./imgs/dmanet.png}
      \caption{Disconnected MANET illustration \cite{Sarah_ijhcr10}}
      \label{fig:dmanet}
    \end{figure}
  \end{frame}
  \begin{frame}
    ...
    \begin{figure}[p]
      \centering
      \includegraphics[height=3cm]{./imgs/store-carry-fwd.png}
      \caption{Store-(carry)-and-forward \cite{ucami12benferhat}}
      \label{fig:dmanet}
    \end{figure}
  \end{frame}
