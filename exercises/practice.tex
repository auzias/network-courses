...
$ping 3564020356.org
\end{verbatim}
What are the differences between the \verb"curl" command and if you go to \color{blue}\href{https://icanhazip.com}{https://icanhazip.com}\color{black} with your web browser?
